...
To configure Winget AutoUpdate in Intune, import and create custom administrative templates. These templates can be downloaded for Github: https://github.com/Romanitho/Winget-AutoUpdate
